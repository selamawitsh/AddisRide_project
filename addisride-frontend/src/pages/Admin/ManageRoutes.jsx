...
import { FaPlus, FaEdit, FaTrash, FaSave, FaTimes, FaMapMarkerAlt, FaExclamationTriangle } from 'react-icons/fa'
...
const ManageRoutes = () => {
  ...
  const handleDelete = async (id) => {
    ...
    try {
      ...
      setDeleteError(error.response?.data?.message || 'Failed to delete route. It may be assigned to vehicles.')
    }
  }
  ...
  // Predefined Addis Ababa locations
